...
async def sanitise_icav2_wes_analysis_orcabus_id(analysis_id: str) -> str:
    if ORCABUS_ULID_REGEX_MATCH.match(analysis_id):
        return analysis_id
    elif ORCABUS_ULID_REGEX_MATCH.match(f"{ICAV2_WES_ANALYSIS_PREFIX}.{analysis_id}"):
        return f"{ICAV2_WES_ANALYSIS_PREFIX}.{analysis_id}"
